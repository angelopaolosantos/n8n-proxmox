...
resource "proxmox_virtual_environment_container" "n8n_container" {
  ...
  operating_system {
    template_file_id = proxmox_virtual_environment_download_file.n8n_ubuntu_24_04_standard_img.id
    type             = "ubuntu"
  }
...
resource "proxmox_virtual_environment_download_file" "n8n_ubuntu_24_04_standard_img" {
  content_type = "vztmpl"
  datastore_id = "local"
  node_name    = "pve01"
  file_name = "n8n-ubuntu-24.04-standard.tar.zst"
